...
class Folder {
    public:
        /**
         * Constructor
         * @param folderName string path to the folder
         */
        Folder(std::string folderName = "./");

        /**
         * Copy Constructor
         * @param src source instance of Folder
         */ 
         ...
         * @param f pointer to the folder to be compared with
         ...
         * @param f pointer to the file to be searchod for
         ...
         * @param file string filename (filename.extension)
