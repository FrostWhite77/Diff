...
class File {
    public:
        /*
         * Constructor
         * @param[in] fileName: string path to the file
         */ 
        File(std::string fileName = "");
        
        /*
         * Copy Constructor
         * @param[in] src: source instance of File
         */ 
        File(const File & src);
         ...
         * Operator << overload
         * @param[in] os: ostream where will be printed
         * @param[in] src: instance of File which will be printed
         */ 
...
class BinFile : public File {
    public:
         ...
         * Operator << overload
         * @param[in] os: ostream where will be printed
         * @param[in] src: instance of BinFile which will be printed
         */ 
...
class TxtFile : public File {
    public:
        ...
        /*
         * Copy Constructor
         * @param[in] src: source instance of TxtFile
         */ 
         ...
         * Operator << overload
         * @param[in] os: ostream where will be printed
         * @param[in] src: instance of TxtFile which will be printed
         */ 
...
class JsnFile : public File {
    public:
        ...
        /*
         * Copy Constructor
         * @param[in] src: source instance of JsnFile
         */ 
         ...
         * Operator << overload
         * @param[in] os: ostream where will be printed
         * @param[in] src: instance of JsnFile which will be printed
         */ 
