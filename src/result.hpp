...
class Result {
    public:
        /**
         * Constructor
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param result comparation result
         */ 
        Result(const std::string & fileX, const std::string & fileY, bool result);

        /**
         * Copy Constructor
         * @param src source instance of Result
         */ 
         ...
         * Operator << overload
         * @param os ostream where will be printed
         * @param src instance of Result which will be printed
         */ 
...
class BinResult : public Result {
    public:
         ...
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param bytesX vector of unique bytes in the first file
         * @param bytesY vector of unique bytes in the second file
         * @param result comparation result
         */ 
        ...
        /**
         * Copy Constructor
         * @param src source instance of BinResult
         */ 
...
class TxtResult : public Result {
    public:
         ...
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param linesX vector of unique lines in the first file
         * @param linesY vector of unique lines in the second file
         * @param result comparation result
         */ 
        ...
        /**
         * Copy Constructor
         * @param src source instance of TxtResult
         */ 
...
class JsnResult : public Result {
    public:
         ...
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param nodesX vector of unique nodes in the first file
         * @param nodesY vector of unique nodes in the second file
         * @param result comparation result
         */ 
        ...
        /**
         * Copy Constructor
         * @param src source instance of JsnResult
         */ 
...
class FileFolderResult : public Result {
    public:
         ...
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param filesCompareResult pointer to the result of comparation of the file and file in the folder
         */ 
        FileFolderResult(const std::string & fileX, const std::string & fileY, Result * filesCompareResult);
        
        /**
         * Copy Constructor
         * @param src source instance of FileFolderResult
         */ 
...
class FolderResult : public Result {
    public:
         ...
         * @param fileX string path to the first file
         * @param fileY string path to the second file
         * @param results results of comparation of the files with the same names 
         * @param uFilesX files which are unique for the first folder
         * @param uFilesY files which are unique for the second folder
         */ 
        ...
        /**
         * Copy Constructor
         * @param src source instance of FolderResult
         */ 
